...
def metrics_report(Y_true, Y_pred, nboots=100, n_jobs=4, prefix='test'):
    ...
    results = {
        f'{prefix}/f1': f1,
        f'{prefix}/f1_low': f1_low,
        f'{prefix}/f1_hi': f1_hi,
        f'{prefix}/phi': phi,
        f'{prefix}/phi_low': phi_low,
        f'{prefix}/phi_hi': phi_hi,
        f'{prefix}/kappa': kappa,
        f'{prefix}/kappa_low': kappa_low,
        f'{prefix}/kappa_hi': kappa_hi}
    return results


def write_experiment_results_to_csv(record, path=None, cfg=None):
    if path is None:
